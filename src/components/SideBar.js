...
function SideBar(props){
    return(
        <div class="bg-azulPadrao w-52 h-screen mt-martop text-white flex justify-center items-start pt-14 font-roboto1 fixed border-1 border-r border-roxoBorda z-10 md:hidden opacity-90 ">
            <ul>
